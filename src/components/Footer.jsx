...
const Footer = () => {
  return (
    <footer className="bg-[#011C2A] text-white py-12 px-[121px] pt-[169px]">
      <div className="border-t-[1px] border-[#FFFFFF] container pt-6 flex justify-between">
        {/* Reach Us */}
        <div className="w-fit mt-4 flex flex-col gap-4">
          <h4 className="font-bold ">REACH US</h4>
          <p className="flex gap-4"><img className="w-6 h-6 object-contain" src={phone} /> 08120694955</p>
          <p className='flex gap-4'><img className="w-6 h-6 object-contain" src={mail} /> anamelechiemmanuel2@gmail.com</p>
        </div>
        ...
        {/* Newsletter */}
        <div className="w-fit bg-[#011621] flex gap-4 flex-col p-4 rounded-[10px]">
          <h4 className="font-bold">Join Our Newsletter</h4>
          <form className='flex w-fit bg-[#02273A]'>
            <input type="email" placeholder="your email address" className="w-[172px] p-2 bg-gray-700 text-white" />
            <button type="submit" className="w-[105px] bg-primary h-full bg-[#000E15] p-2">Subscribe</button>
          </form>
          <p className="text-xs w-[277px] text-gray-400">* We will send you weekly updates for your better tool management.</p>
        </div>
      </div>
    </footer>
  );
